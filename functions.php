...
$wp_sms_post = get_post();
$wp_sms_post_ID = $wp_sms_post->ID;
$wp_sms_post_title = $wp_sms_post->post_title;
...
function detect_published_post ( $wp_sms_new_status, $wp_sms_old_status, $wp_sms_post_ID ) {
	if ( $wp_sms_new_status == 'publish' && $wp_sms_old_status != 'publish' ) {
		wp_sms_send_notification( '9806215740@messaging.sprintpcs.com', 'New Changes to your WordPress site', "This new post has been published: {$wp_sms_post_title}" );	
	}
}
