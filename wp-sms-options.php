		...
		<div class="wrap">
				...
				<form method="post" action="tools.php?page=wp-sms-notifications">
					...
					foreach ( $blogusers as $user ) :
						...
						<tr valign="top">
							...
							<td><input type="checkbox" name="wp_sms_allowed" value="1" <?php checked( $user_allowed, '1' ); ?>/></td>
			...
			<div style="margin-left:auto; float:right;">
				...
				<table style="border-collapse:collapse;border-spacing:0;">
					<tr>
						<th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;"><h3><center>Personal License</center></h3></th>
						<th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;"><h3><center>Developer License</center></h3></th>
						<th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;"><h3><center>Agency License</center></h3></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="font-family:Arial, sans-serif;font-size:14px;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;"><center>5 Sites</center></td>
						<td style="font-family:Arial, sans-serif;font-size:14px;padding:10px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;"><center>30 Sites</center></td>
					</tr>
					<tr>
