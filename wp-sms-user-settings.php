	...
	function wp_sms_user_settings( $user ) {
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="text" name="wp_sms_phone_number" value="<?php echo get_user_meta( $user->ID, 'wp_sms_phone_number', 'true' ); ?>"/>
				</td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_post_publish" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_post_publish', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_post_update" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_post_update', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_user_login" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_user_login', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_plugin_install" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_plugin_install', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_plugin_update" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_plugin_update', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_theme_install" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_theme_install', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wp_sms_on_theme_update" value="1" <?php if ( get_the_author_meta( 'wp_sms_on_theme_update', $user->ID ) == '1' ) {
						echo 'checked';
					} ?>/></td>
			</tr>
			<?php ?>
